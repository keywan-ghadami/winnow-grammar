...
grammar! {
    grammar WsRepro {
        // Suppress unused warning because 'WS// Nicht verwendete Warnung unterdrücken, da 'WS' implizit vom Parsergenerator verwendet wird ' is used implicitly by the parser generator
